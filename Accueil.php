...
<body class="bg-gray-900 text-white font-sans">
  ...
  <nav class="bg-gray-800 p-4 sticky top-0 shadow-md">
    <div class="max-w-6xl mx-auto flex justify-between items-center">
      ...
      <ul class="hidden md:flex space-x-6">
        <li><a href="Accueil.php" class="hover:text-yellow-400">Accueil</a></li>
        <li><a href="Tournoi.php" class="hover:text-yellow-400">Tournois</a></li>
        <li><a href="Tarifs.php" class="hover:text-yellow-400">Tarifs</a></li>
        <li><a href="Contact.php" class="hover:text-yellow-400">Contact</a></li>
        <li><a href="Connexion.php" class="hover:text-yellow-400">Connexion</a></li>
      </ul>
  ...
  <section id="accueil" class="text-center py-20 bg-gradient-to-r from-gray-900 to-gray-700">
    ...
    <a href="Tournoi.php" class="bg-yellow-400 text-black px-6 py-3 rounded-lg font-bold hover:bg-yellow-300">
      Voir les tournois
    </a>
  </section>
