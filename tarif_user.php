<?php
// tarif_user.php
require_once __DIR__ . '/config_user_DB.php'; // connexion PDO si tu veux récupérer dynamiquement depuis BDD

// --- Liste des tarifs avec jeux exacts ---
$tarifs = [
    [
        "plateforme" => "PC",
        "prix" => "2,5€ / heure",
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      <?php foreach ($tarifs as $t) : ?>
        <div class="bg-gray-800 p-6 rounded-xl shadow-lg flex flex-col justify-between">
          ...
          <!-- BOUTON RÉSERVER -->
          <form action="reservation_user.php" method="GET" class="mt-4">
