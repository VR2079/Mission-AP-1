...
<body class="bg-gray-900 text-white">
 ...
 <!-- BANNIERE TOURNOI -->
	...
	<video autoplay loop muted playsinline class="absolute inset-0 w-full h-full object-contain bg-black">
		<source src="medias%20&%20logos/montage melee.mp4" type="video/mp4">
		<!-- si jamais la navigateur ne peut pas lire la vidéo (rare) -->
...
<section class="max-w-6xl mx-auto py-12 px-6">
  ...
  <div class="mt-8 text-center">
    <a href="liste_match.php" class="bg-yellow-400 text-black font-bold px-6 py-3 rounded-lg hover:bg-yellow-300">
